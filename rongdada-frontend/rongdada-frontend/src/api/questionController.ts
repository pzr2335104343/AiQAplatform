...
/** aiSseGenerateQuestionTest GET /api/question/ai_generate/sse/test */
export async function aiSseGenerateQuestionTestUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.aiSseGenerateQuestionTestUsingGETParams,
  options?: { [key: string]: any },
) {
