...
import com.pzr.rongdada.model.dto.userAnswer.UserAnswerAddRequest;
import com.pzr.rongdada.model.dto.userAnswer.UserAnswerEditRequest;
import com.pzr.rongdada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.pzr.rongdada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.pzr.rongdada.model.vo.UserAnswerVO;
import com.pzr.rongdada.scoring.ScoringStrategyExecutor;
import com.pzr.rongdada.service.AppService;
import com.pzr.rongdada.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new BusinessException(ErrorCode.OPERATION_ERROR,"重复提交,或操作失误导致评分错误");
        }
    ...
    public BaseResponse<Long> generateSnowAnswerId(){
